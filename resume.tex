...
\newcommand{\resumeEntry}[3]{%
	\noindent\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}lr}
		\large{\textbf{#1}} \small{\textit{#2}} & \large{#3} \\
...
\begin{center}
	...
	Ann Arbor, MI \hspace{5pt} (248)-775-9622 \hspace{5pt} aidenwen@umich.edu \hspace{5pt} github.com/aiden-wenzel
\end{center}
...
\resumeEntry{University of Michigan}{Electrical Engineering, BSE}{September 2023 - May 2027}
...
\resumeEntry{Coretek}{Technical Support Specialist}{May 2024 - July 2025}
\begin{itemize}[noitemsep]
...
\hrule
\vspace{3pt}
\resumeEntry{Fractal Visualizer}{C++}{}
\begin{itemize}[noitemsep]
...
\resumeEntry{Conway's Game of Life}{C++}{}
\begin{itemize}[noitemsep]
...
\resumeEntry{Instrument Recognition Software}{Python}{}
\begin{itemize}[noitemsep]
...
\resumeEntry{Michigan Marching Band}{Piccolo}{}
\begin{itemize}[noitemsep]
